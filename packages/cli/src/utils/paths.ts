...
export const REGISTRY_URL = "https://raw.githubusercontent.com/brunoqgalvao/claude-skills-directory/main/data/skills";
export const REGISTRY_INDEX_URL = "https://raw.githubusercontent.com/brunoqgalvao/claude-skills-directory/main/data/skills-index.json";
